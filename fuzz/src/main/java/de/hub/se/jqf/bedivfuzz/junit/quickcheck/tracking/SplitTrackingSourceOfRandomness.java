...
public class SplitTrackingSourceOfRandomness implements SplitRandom {
    ...
    private final TrackingSourceOfRandomness structureDelegate;
    private final TrackingSourceOfRandomness valueDelegate;
    ...
    public SplitTrackingSourceOfRandomness(
        ...
        StreamBackedRandom delegate = new TypedStreamBackedRandom((TypedInputStream) input, 3 * Long.BYTES);
        ...
        this.structureDelegate = new TrackingSourceOfRandomness(structuralChoiceIndices, trackingState);
        this.valueDelegate = new TrackingSourceOfRandomness(valueChoiceIndices, trackingState);
    }

    // Exposed for testing
    public SplitTrackingSourceOfRandomness(InputStream input) {

 ...
 *
 */
public class DiversityMetricBuilder {
    public static class HillNumbers{
        public double h_0;
        public double h_1;
        public double h_2;
    }
    public static HillNumbers hillNumbersFromCoverage(ICoverage coverageAccumulatedFromUniqueTraces) {
        Counter counter = coverageAccumulatedFromUniqueTraces.getCounter();
